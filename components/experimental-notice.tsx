 ...
 * exercise and every desk's output is AI-generated. Shown at the top of the
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
        Every desk is an autonomous AI agent. All research, scores and verdicts
        are produced by AI models against frameworks you can inspect — treat
